(function (global, factory) {
	...
	var shim$3 = function (searchString              ) {
	...
	var from_1 = isImplemented$4()
		? Array.from
		: shim$4;

	var isArray$1 = Array.isArray;
	var toArray = function (arrayLike) {
		return isArray$1(arrayLike) ? arrayLike : from_1(arrayLike);
	};
	...
	var slice$1 = Array.prototype.slice, apply$1 = Function.prototype.apply, create$5 = Object.create;
	...
	registeredExtensions.promise = function (mode, conf) {
		var waiting = create$7(null), cache = create$7(null), promises = create$7(null);
		if (mode === true) {
			mode = null;
		} else {
		...
		conf.on("clear", function () {
			var oldCache = cache;
			cache = create$7(null);
			waiting = create$7(null);
			promises = create$7(null);
	...
	var noop$1 = Function.prototype, max$2 = Math.max, min = Math.min, create$8 = Object.create;
	...
	var create$9 = Object.create, hasOwnProperty$1 = Object.prototype.hasOwnProperty;
	var lruQueue = function (limit) {
		...
		return {
			hit: function (id) {
				...
				while (!hasOwnProperty$1.call(queue, ++base)) { continue; }
			},
	...
	var create$a = Object.create, defineProperties$2 = Object.defineProperties;
	...
	var objectLength = pipe(keys$3, propLength);
	...
	var floor$2 = function (x) { return Math.floor(Math.random() * x); };
	var floorMin = curry(function (min, x) { return floor$2(x) + min; });
	var f =              Object.freeze({
	  floor: floor$2,
	  floorMin: floorMin
	});
	...
	var __willDelegate = function (method, functor) { return (
	  has(method, functor) && !isArray$2(functor)
	); };
	...
	var map$2$1 = function fastMap (subject, fn, thisContext) {
	  if (subject instanceof Array) {
	    return map$2(subject, fn, thisContext);
	  }
	  else {
	...
	var isFunction$1 = isTypeof("function");
	var isString$1 = isTypeof("string");
	var isObject$1 = isTypeof("object");
	...
	var forceString = function (x) { return (isString$1(x) ? x : STRINGS.empty); };
	var bem = memoizee(function λbem(b, e, m) {
	  return pipe(
	    forceString,
	    neue,
	...
	var make = memoizee(function λmake(b) {
	  return memoizee(function λmakeElement(e, m) {
	    return m
	      ? pipe(
	          neue,
	          map$3(function (m2) { return bem(b, e, m2); }),
	          triplet(
	            function (x) { return isArray$1$1(x) && !isString$1(x[0]); },
	            first,
	            pipe(
	              reduce$3(concat, []),
	              uniq,
	...
	exports.safeprepend = safeprepend;
